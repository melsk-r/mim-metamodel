...
4. In het voorbeeld wordt gebruik gemaakt van een driehoekje om de leesrichting van de verwoording te duiden. Conform UML (zie [sectie 11.5.4 UML versie 2.5.1](https://www.omg.org/spec/UML/2.5.1/PDF)) is dit de juiste manier om een leesrichting aan te geven, hoewel in de praktijk ook de navigatie-pijlpunt hiervoor wordt gelezen.
